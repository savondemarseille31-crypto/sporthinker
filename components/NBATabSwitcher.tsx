      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="text-xs text-gray-500 border-b border-gray-800">
            ...
            {tab === 'pts' && (
              <>
                <th className="text-center py-2 px-2 text-emerald-400">PTS</th>
            ...
            {tab === 'reb' && (
              <>
                <th className="text-center py-2 px-2 text-emerald-400">REB</th>
            ...
            {tab === 'ast' && (
              <>
                <th className="text-center py-2 px-2 text-emerald-400">AST</th>
                <th className="text-center py-2 px-2">PTS</th>
                <th className="text-center py-2 px-2">REB</th>
                <th className="text-center py-2 px-2">GP</th>
              </>
            ...
            {tab === 'blk' && (
              <>
                <th className="text-center py-2 px-2 text-emerald-400">BLK</th>
                <th className="text-center py-2 px-2">PTS</th>
                <th className="text-center py-2 px-2">REB</th>
                <th className="text-center py-2 px-2">GP</th>
              </>
            ...
            {tab === 'stl' && (
              <>
                <th className="text-center py-2 px-2 text-emerald-400">STL</th>
                <th className="text-center py-2 px-2">PTS</th>
                <th className="text-center py-2 px-2">AST</th>
                <th className="text-center py-2 px-2">GP</th>
              </>
