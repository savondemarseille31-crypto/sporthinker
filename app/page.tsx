      ...
      <section id="tarifs" className="px-6 py-12 max-w-5xl mx-auto scroll-mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          ...
          <div className="bg-gray-900 border border-emerald-500/40 rounded-2xl p-6 relative flex flex-col">
            ...
            <p className="text-xs font-semibold text-emerald-400 mb-4">2 mois offerts vs mensuel</p>
            <ul className="text-sm text-gray-400 space-y-2 mb-6">
              <li>✓ Tous les signaux du jour, tous sports</li>
              <li>✓ Toutes les values (EV)</li>
              <li>✓ Suivi personnel synchronisé</li>
            </ul>
            <SubscribeButton plan="annual" className="w-full mt-auto bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 text-black font-bold py-2.5 rounded-xl transition-colors">
              Je m&apos;abonne
            </SubscribeButton>
          </div>
        </div>
