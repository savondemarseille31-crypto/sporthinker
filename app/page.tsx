  ...
  return (
    <main className="min-h-screen bg-[#0a0d14] text-white">
      ...
      <section className="px-6 pt-16 pb-12 max-w-5xl mx-auto text-center">
        <span className="inline-block text-xs font-semibold text-violet-400 bg-violet-500/10 border border-violet-500/30 rounded-full px-3 py-1 mb-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Link href="/performance" className="bg-violet-500 hover:bg-violet-400 text-black font-bold px-6 py-3 rounded-xl transition-colors">
            Voir la performance →
          </Link>
      ...
      <section className="px-6 py-10 max-w-5xl mx-auto">
        <Link href="/performance" className="block bg-[#14171f] border border-[#262b36] hover:border-violet-500/40 rounded-2xl p-6 transition-colors">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <p className="text-3xl font-bold text-violet-400">{s.yield >= 0 ? '+' : ''}{s.yield} %</p>
            ...
            <div>
              <p className="text-3xl font-bold text-violet-400">{s.profitUnits >= 0 ? '+' : ''}{s.profitUnits} u</p>
              <p className="text-xs text-gray-500 mt-1">Profit (unités)</p>
            </div>
          </div>
          <p className="text-xs text-gray-600 text-center mt-5">
            Signaux forts MLB · mise à plat · performances passées ≠ résultats futurs — <span className="text-violet-400">voir le détail vérifiable →</span>
          </p>
        </Link>
      </section>
      ...
      <section className="px-6 py-12 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={step.n} className="bg-[#14171f] border border-[#262b36] rounded-2xl p-6">
              <div className="w-9 h-9 rounded-full bg-violet-500/15 text-violet-400 font-bold flex items-center justify-center mb-4">{step.n}</div>
      ...
      <section className="px-6 py-12 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            ...
            <div key={f.t} className="bg-[#14171f] border border-[#262b36] rounded-2xl p-5 flex gap-4">
      ...
      {/* Pricing */}
      <section id="tarifs" className="px-6 py-12 max-w-5xl mx-auto scroll-mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          {/* Gratuit */}
          <div className="bg-[#14171f] border border-[#262b36] rounded-2xl p-6 flex flex-col">
          ...
          {/* Premium mensuel */}
          <div className="bg-[#14171f] border border-[#262b36] rounded-2xl p-6 flex flex-col">
            <h3 className="font-bold text-white mb-1">Premium mensuel</h3>
            ...
            <SubscribeButton plan="monthly" className="w-full mt-auto bg-violet-500 hover:bg-violet-400 disabled:opacity-50 text-black font-bold py-2.5 rounded-xl transition-colors">
              Je m&apos;abonne
            </SubscribeButton>
          </div>
          {/* Premium annuel */}
          <div className="bg-[#14171f] border border-violet-500/40 rounded-2xl p-6 relative flex flex-col">
            <span className="absolute -top-3 left-6 text-xs font-semibold bg-violet-500 text-black px-2 py-0.5 rounded-full">Recommandé</span>
            <h3 className="font-bold text-white mb-1">Premium annuel</h3>
            <p className="text-3xl font-bold mb-1">199,90 € <span className="text-base font-normal text-gray-500">/ an</span></p>
            <p className="text-xs font-semibold text-violet-400 mb-4">2 mois offerts vs mensuel</p>
            <ul className="text-sm text-gray-400 space-y-2 mb-6">
              <li>✓ Tous les signaux du jour, tous sports</li>
              <li>✓ Toutes les values (EV)</li>
              <li>✓ Suivi personnel synchronisé</li>
            </ul>
            <SubscribeButton plan="annual" className="w-full mt-auto bg-violet-500 hover:bg-violet-400 disabled:opacity-50 text-black font-bold py-2.5 rounded-xl transition-colors">
              Je m&apos;abonne
            </SubscribeButton>
          </div>
        </div>
      ...
      <section className="px-6 py-12 max-w-3xl mx-auto">
        ...
        <div className="space-y-3">
          {[
            ...
            <details key={f.q} className="group bg-[#14171f] border border-[#262b36] rounded-2xl">
      ...
      <section className="px-6 py-16 max-w-3xl mx-auto text-center">
        ...
        <Link href="/performance" className="inline-block bg-violet-500 hover:bg-violet-400 text-black font-bold px-8 py-3 rounded-xl transition-colors">
          Voir la performance →
        </Link>
      </section>
    </main>
