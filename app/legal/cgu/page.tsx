...
export default function CGUPage() {
  return (
    <LegalShell title="Conditions Générales d'Utilisation et de Vente" updated="juin 2026">
      <h2>1. Objet</h2>
      <p>
        Les présentes conditions régissent l&apos;accès et l&apos;utilisation du service <strong>SporThinker</strong>{' '}
        (le « Service »), un <strong>outil d&apos;analyse statistique</strong> à destination des paris sportifs.
        SporThinker n&apos;est pas un opérateur de jeux d&apos;argent, ne prend aucun pari et ne reçoit aucune mise.
      </p>
      ...
      <p>
        Le Service est fourni « en l&apos;état ». SporThinker ne saurait être tenu responsable des pertes liées aux
