...
const btnClass = 'w-full bg-violet-500 hover:bg-violet-400 disabled:opacity-50 text-black font-bold py-2.5 rounded-xl transition-colors'
    ...
    <main className="min-h-screen bg-[#0a0d14] text-white">
      ...
      <div className="px-6 py-12 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-stretch">
          ...
          <div className="bg-[#14171f] border border-violet-500/40 rounded-2xl p-6 flex flex-col">
            <span className="self-start text-xs font-semibold bg-violet-500 text-black px-2 py-0.5 rounded-full">2 mois offerts</span>
